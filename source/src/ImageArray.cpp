...
IEnumerable<DoublePoint>^ ImageArray::CornerSubPixel(IEnumerable<DoublePoint>^ corners, Int32Size windowSize, int maxIteration, double terminationCriteria)
{
  ...
  cornerSubPix(*this->mat, opencvCorners, windowSize, cv::Size(-1, -1), cv::TermCriteria(cv::TermCriteria::Type::COUNT | cv::TermCriteria::Type::EPS, maxIteration, terminationCriteria));
